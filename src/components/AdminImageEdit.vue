        ...
        <form class="form-horizontal" @submit.prevent="validateForm">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input v-validate="'required|url'" type="text" class="form-control" id="thumbnail" name="thumbnail" placeholder="Thumbnail of the image" v-model="image.thumbnail">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input v-validate="'required|url'" type="text" class="form-control" id="imageLink" name="imageLink" placeholder="Link of the image" v-model="image.imageLink">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input v-validate="'required|min:5'" type="text" class="form-control" id="title" name="title" placeholder="Title" v-model="image.title">
